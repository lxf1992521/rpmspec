...
# touch %{buildroot}%{_localstatedir}/log/nginx/error.log
...
%attr(755,%{nginx_user},root) %dir %{_localstatedir}/lib/nginx
%attr(755,%{nginx_user},root) %dir %{_localstatedir}/lib/nginx/tmp
%attr(755,%{nginx_user},root) %dir %{_localstatedir}/log/nginx
# %attr(777,%{nginx_user},root) %{_localstatedir}/log/nginx/error.log
